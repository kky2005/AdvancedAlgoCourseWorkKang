...
def show_menu() -> str:
    ...
    print("  │  5. Insert New Transaction                [Optional] │")
    print("  │  6. Sort by Different Attribute           [Optional] │")
    print("  │  7. Performance Comparison                [Optional] │")
    print("  │  8. Time Complexity Analysis Table        [Optional] │")
    print("  │  0. Exit                                             │")
    print("  └──────────────────────────────────────────────────────┘")
